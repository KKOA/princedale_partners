...
<div class="hero about-image">
        ...
        <div class="desktop-logos">
            ...
            <div class="section group">
                ...
                <p class="case-study-line-hide">Click on a logo to read a full case study</p>
            </div>
            
            <div class="section group logos">
                <div>
                    <a href="case-studies/coca-cola.html">
                        <img src="img/logo-coca-cola.png" alt="Coca Cola Logo"></a>
                    <a href="case-studies/coca-cola.html" class="case-study-title-hide">
                        <span>Digital Director</span><br>&gt; Read full case study</a>
                </div>	
                <div class="logo-adjust">
                    <a href="case-studies/thomas-cook.html">
                        <img src="img/logo-thomas-cook.png" alt="Thomas Cook Logo"></a>
                    <a href="case-studies/thomas-cook.html" class="case-study-title-hide">
                        <span>Group Head, Digital Experience</span><br>&gt; Read full case study</a>
                </div>
                <div>
                    <a href="case-studies/holland-barrett.html">
                        <img src="img/logo-holland-barrett.png" alt="Holland and Barrett Logo"></a>
                    <a href="case-studies/holland-barrett.html" class="case-study-title-hide">
                        <span>Director, Digital/Ecommerce</span><br>&gt; Read full case study</a>
                </div>	
                <div>
                    <a href="case-studies/body-shop.html">
                        <img src="img/logo-body-shop.png" alt="Body Shop Logo"></a>
                    <a href="case-studies/body-shop.html" class="case-study-title-hide">
                        <span>Chief Digital Officer</span>
                        <br>&gt; Read full case study</a>
                </div>											
            </div><!-- logo-line-1 -->
            ...
            <div class="section group logos">
                <div>
                    <a href="case-studies/zalando.html">
                        <img src="img/logo-zalando.png" alt="Zalando Logo"></a>
                    <a href="case-studies/zalando.html" class="case-study-title-hide">
                        <span>UK Country Manager</span><br>&gt; Read full case study</a>
                </div>	
                <div class="logo-adjust">
                    <a href="case-studies/photobox.html">
                        <img src="img/logo-photobox.png" alt="Photobox Logo"></a>
                    <a href="case-studies/photobox.html" class="case-study-title-hide">
                        <span>Director, Customer Insight</span><br>&gt; Read full case study</a>
                </div>
                <div>
                    <a href="case-studies/secret-escapes.html">
                        <img src="img/logo-secret-escapes.png" alt="Secret Escapes Logo"></a>
                    <a href="case-studies/secret-escapes.html" class="case-study-title-hide">
                        <span>Merchandising Director</span><br>&gt; Read full case study</a>
                </div>
                <div>
                    <a href="case-studies/audio-network.html">
                        <img src="img/logo-audio-network.png" alt="The Audio Network Logo"></a>
                    <a href="case-studies/audio-network.html" class="case-study-title-hide">
                        <span>Product Director</span><br>&gt; Read full case study</a>
                </div>								
            </div><!-- logo-line-2 -->			
    ...
    <div class="phone-logos">
        ...
        <div class="section group logos">
            <div>
                <a href="case-studies/coca-cola.html"><img src="img/logo-coca-cola.png" alt="Coca Cola Logo"></a>
                <a href="case-studies/coca-cola.html"><span>Digital Director</span><br>&gt; Read full case study</a>
            </div>	
            <div class="logo-adjust">
                <a href="case-studies/thomas-cook.html"><img src="img/logo-thomas-cook.png" alt="Thomas Cook Logo"></a>
                <a href="case-studies/thomas-cook.html"><span>Group Head, Digital Experience</span><br>&gt; Read full case study</a>
            </div>
            <div>
                <a href="case-studies/holland-barrett.html"><img src="img/logo-holland-barrett.png" alt="Holland and Barrett Logo"></a>
                <a href="case-studies/holland-barrett.html"><span>Director, Digital/Ecommerce</span><br>&gt; Read full case study</a>
            </div>	
            <div>
                <a href="case-studies/body-shop.html"><img src="img/logo-body-shop.png" alt="Body Shop Logo"></a>
                <a href="case-studies/body-shop.html"><span>Chief Digital Officer</span><br>&gt; Read full case study</a>
            </div>											
        </div><!-- logo-line-1 -->
        
        <div class="section group logos">
            <div>
                <a href="case-studies/zalando.html"><img src="img/logo-zalando.png" alt="Zalando Logo"></a>
                <a href="case-studies/zalando.html"><span>UK Country Manager</span><br>&gt; Read full case study</a>
            </div>	
            <div class="logo-adjust">
                <a href="case-studies/photobox.html"><img src="img/logo-photobox.png" alt="Photobox Logo"></a>
                <a href="case-studies/photobox.html"><span>Director, Customer Insight</span><br>&gt; Read full case study</a>
            </div>
            <div>
                <a href="case-studies/secret-escapes.html"><img src="img/logo-secret-escapes.png" alt="Secret Escapes Logo"></a>
                <a href="case-studies/secret-escapes.html"><span>Merchandising Director</span><br>&gt; Read full case study</a>
            </div>
            <div>
                <a href="case-studies/audio-network.html"><img src="img/logo-audio-network.png" alt="The Audio Network Logo"></a>
                <a href="case-studies/audio-network.html"><span>Product Director</span><br>&gt; Read full case study</a>
            </div>								
        </div><!-- logo-line-2 -->			
